...
__export(telemetry_exports, {
  _getTelemetryOperations: () => _getTelemetryOperations
});
module.exports = __toCommonJS(telemetry_exports);
var import_operations = require("../../api/telemetry/operations.js");
function _getTelemetry(connections) {
  const telemetryOperations = (0, import_operations.createTelemetryOperations)(connections);
  return {
