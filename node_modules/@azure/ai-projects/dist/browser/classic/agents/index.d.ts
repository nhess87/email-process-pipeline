...
import type { AgentsListVersionsOptionalParams, AgentsDeleteVersionOptionalParams, AgentsGetVersionOptionalParams, AgentsCreateAgentVersionFromManifestOptionalParams, AgentsCreateVersionOptionalParams, AgentsListOptionalParams, AgentsDeleteOptionalParams, AgentsUpdateAgentFromManifestOptionalParams, AgentsCreateAgentFromManifestOptionalParams, AgentsUpdateOptionalParams, AgentsCreateOptionalParams, AgentsGetOptionalParams } from "../../api/agents/options.js";
import type { Agent, AgentVersion, AgentDefinitionUnion, DeleteAgentResponse, DeleteAgentVersionResponse } from "../../models/models.js";
...
export declare function _getAgentsOperations(context: AIProjectContext): AgentsOperations;
