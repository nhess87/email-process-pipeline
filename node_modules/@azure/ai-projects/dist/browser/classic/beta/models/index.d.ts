...
import type { BetaModelsGetCredentialsOptionalParams, BetaModelsPendingUploadOptionalParams, BetaModelsUpdateOptionalParams, BetaModelsDeleteOptionalParams, BetaModelsGetOptionalParams, BetaModelsListOptionalParams, BetaModelsListVersionsOptionalParams } from "../../../api/beta/models/options.js";
import type { DatasetCredential, ModelVersion, UpdateModelVersionRequest, ModelPendingUploadRequest, ModelPendingUploadResponse, ModelCredentialRequest } from "../../../models/models.js";
...
export declare function _getBetaModelsOperations(context: AIProjectContext): BetaModelsOperations;
