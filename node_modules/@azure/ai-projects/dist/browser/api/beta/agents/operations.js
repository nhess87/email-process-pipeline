...
import { agentDeserializer, agentVersionDeserializer, agentEndpointConfigSerializer, agentCardSerializer, apiErrorResponseDeserializer, createAgentVersionFromCodeContentSerializer, versionIndicatorUnionSerializer, agentSessionResourceDeserializer, _agentsPagedResultAgentSessionResourceDeserializer, sessionFileWriteResponseDeserializer, sessionDirectoryListResponseDeserializer, optimizationJobInputsSerializer, optimizationJobDeserializer, _agentsPagedResultOptimizationJobDeserializer, agentsPagedResultOptimizationCandidateDeserializer, candidateMetadataDeserializer, candidateDeployConfigDeserializer, candidateResultsDeserializer, promoteCandidateRequestSerializer, promoteCandidateResponseDeserializer, } from "../../../models/models.js";
...
export function _deleteOptimizationJobSend(context, jobId, options = { requestOptions: {} }) {
    const foundryFeatures = "HostedAgents=V1Preview,AgentEndpoints=V1Preview";
    const path = expandUrlTemplate("/agent_optimization_jobs/{jobId}{?force,api-version}", {
        jobId: jobId,
        force: options?.force,
        "api-version": context.apiVersion,
    }, {
...
export async function _deleteOptimizationJobDeserialize(result) {
...
export async function deleteOptimizationJob(context, jobId, options = { requestOptions: {} }) {
    const result = await _deleteOptimizationJobSend(context, jobId, options);
    return _deleteOptimizationJobDeserialize(result);
}
export function _cancelOptimizationJobSend(context, jobId, options = { requestOptions: {} }) {
    const path = expandUrlTemplate("/agent_optimization_jobs/{jobId}:cancel{?api-version}", {
        jobId: jobId,
        "api-version": context.apiVersion,
    }, {
        allowReserved: options?.requestOptions?.skipUrlEncoding,
...
export async function _cancelOptimizationJobDeserialize(result) {
    const expectedStatuses = ["200"];
    if (!expectedStatuses.includes(result.status)) {
        const error = createRestError(result);
        error.details = apiErrorResponseDeserializer(result.body);
...
export function _listOptimizationJobsSend(context, options = { requestOptions: {} }) {
    const path = expandUrlTemplate("/agent_optimization_jobs{?limit,order,after,before,status,agent_name,api-version}", {
        limit: options?.limit,
        order: options?.order,
        after: options?.after,
        before: options?.before,
...
export async function _listOptimizationJobsDeserialize(result) {
    const expectedStatuses = ["200"];
    if (!expectedStatuses.includes(result.status)) {
        const error = createRestError(result);
        error.details = apiErrorResponseDeserializer(result.body);
...
export function listOptimizationJobs(context, options = { requestOptions: {} }) {
    return buildPagedAsyncIterator(context, () => _listOptimizationJobsSend(context, options), _listOptimizationJobsDeserialize, ["200"], { itemName: "data", apiVersion: context.apiVersion });
}
export function _getOptimizationJobSend(context, jobId, options = { requestOptions: {} }) {
...
export function _createOptimizationJobSend(context, inputs, options = { requestOptions: {} }) {
    const foundryFeatures = "HostedAgents=V1Preview,AgentEndpoints=V1Preview";
...
export async function createOptimizationJob(context, inputs, options = { requestOptions: {} }) {
