...
import { apiErrorResponseDeserializer, insightRequestUnionSerializer, insightDeserializer, _pagedInsightDeserializer, } from "../../../models/models.js";
...
export function _listSend(context, options = { requestOptions: {} }) {
    ...
    const path = expandUrlTemplate("/insights{?api-version,type,evalId,runId,agentName,includeCoordinates}", {
...
export function _getSend(context, insightId, options = { requestOptions: {} }) {
    const foundryFeatures = "Insights=V1Preview";
    const path = expandUrlTemplate("/insights/{id}{?api-version,includeCoordinates}", {
        id: insightId,
        includeCoordinates: options?.includeCoordinates,
        "api-version": context.apiVersion,
    }, {
...
export async function get(context, insightId, options = { requestOptions: {} }) {
    const result = await _getSend(context, insightId, options);
    return _getDeserialize(result);
}
export function _generateSend(context, insight, options = { requestOptions: {} }) {
    const foundryFeatures = "Insights=V1Preview";
    const path = expandUrlTemplate("/insights{?api-version}", {
        "api-version": context.apiVersion,
    }, {
        allowReserved: options?.requestOptions?.skipUrlEncoding,
    });
...
export async function _generateDeserialize(result) {
...
/** Generate Insights */
export async function generate(context, insight, options = { requestOptions: {} }) {
